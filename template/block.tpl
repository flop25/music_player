...
#block_mp li a {literal}{{/literal}
	display: block ;
	background: transparent url({$PLG_path}/template/icon/fond1.png) left top no-repeat ;
	padding: 4px ;
	text-align: center ;
	with: 150px;
	height: 50px;
...
#block_mp li a:hover, #block_mp li a:focus, #block_mp li a:active {literal}{{/literal}
	background: transparent url({$PLG_path}/template/icon/fond2.png) left top no-repeat ;
	{literal}}{/literal}
